...
---
Generated by [DevFlow](https://devflow.dev)
`;
}
      ...
      <div className="space-y-8">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span
                    ...
                    style={{ background: "var(--accent-cyan-dim)", color: "var(--accent-cyan)", border: "1px solid var(--border-default)", fontFamily: "var(--font-syne), sans-serif" }}
                  >
                    {tool.category}
                  </span>
                </div>
            ...
            {result.buildSteps.map((step, i) => (
              <li key={i} className="flex gap-4">
                <span
                  ...
                  style={{ background: "var(--accent-cyan-dim)", color: "var(--accent-cyan)", border: "1px solid var(--border-default)", fontFamily: "var(--font-jetbrains-mono), monospace" }}
                >
                  {i + 1}
                </span>
        ...
        >
          <p className="text-sm mb-4" style={{ color: "var(--text-tertiary)" }}>
            Generated by DevFlow — AI dev workflows and architecture recommendations.
          </p>
          <Link
            href="/generate"
